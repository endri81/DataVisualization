...
\phantomsection\label{plotting-many-variables-at-once}
\begin{itemize}
\item
...
\phantomsection\label{when-should-you-use-a-pair-plot}
...
\phantomsection\label{pair-plot-all}
...
\phantomsection\label{pair-diag-disc}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{pair-diag-cts}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{pair cts}
\phantomsection\label{pair-cts-1}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{pair-combo}
\begin{itemize}
\item
...
\phantomsection\label{pair-plot-all-again}
...
\phantomsection\label{pair-corr}
...
\phantomsection\label{when-should-you-use-a-correlation-heatmap}
\begin{itemize}
\item
...
\phantomsection\label{corr-heat}
...
\begin{frame}{corr heat}
\phantomsection\label{corr-heat-1}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{the-united-nations-dataset-again}
...
\begin{frame}{The United Nations dataset again}
\phantomsection\label{the-united-nations-dataset-again-1}
...
\phantomsection\label{when-should-you-use-a-parallel-coordinates-plot}
\begin{itemize}
\item
...
\phantomsection\label{para-coord-by-continent}
...
\begin{frame}{para coord by continent}
\phantomsection\label{para-coord-by-continent-1}
\begin{itemize}
\item
...
\begin{frame}{para coord by continent}
\phantomsection\label{para-coord-by-continent-2}
\begin{itemize}
\item
...
\begin{frame}{para coord by continent}
\phantomsection\label{para-coord-by-continent-3}
\begin{itemize}
\item
...
\phantomsection\label{practice-interpreting-pair-plots}
...
\phantomsection\label{pair-plot-visualization}
...
\begin{frame}{Question 1}
\phantomsection\label{question-1-1}
\begin{block}{Most animals were traveling at less than 1 m/s when caught
on camera.}
\phantomsection\label{most-animals-were-traveling-at-less-than-1-ms-when-caught-on-camera.}
\begin{itemize}
\tightlist
\item
  True
...
\phantomsection\label{feedback-for-question-1}
\textbf{Answer:} True\\
...
\begin{frame}{Question 2}
\phantomsection\label{question-2-1}
\begin{block}{There are more than 250 sightings of peccary in the
dataset.}
\phantomsection\label{there-are-more-than-250-sightings-of-peccary-in-the-dataset.}
\begin{itemize}
\tightlist
\item
  True
...
\phantomsection\label{feedback-for-question-2}
\textbf{Answer:} True\\
The bar chart in the pair plot shows the peccary count exceeds 250.
\end{frame}

\begin{frame}{Question 3}
\phantomsection\label{question-3-1}
\begin{block}{Paca is the only nocturnal animal in the dataset.}
\phantomsection\label{paca-is-the-only-nocturnal-animal-in-the-dataset.}
\begin{itemize}
\tightlist
\item
  True
...
\phantomsection\label{feedback-for-question-3}
\textbf{Answer:} False\\
...
\begin{frame}{Question 4}
\phantomsection\label{question-4-1}
\begin{block}{The animal with the fastest 75th percentile speed on
camera was an agouti.}
\phantomsection\label{the-animal-with-the-fastest-75th-percentile-speed-on-camera-was-an-agouti.}
\begin{itemize}
\tightlist
\item
  True
...
\phantomsection\label{feedback-for-question-4}
\textbf{Answer:} False\\
...
\begin{frame}{Question 5}
\phantomsection\label{question-5-1}
\begin{block}{All species were caught on camera most often around dawn
(6 AM) and dusk (6 PM).}
\phantomsection\label{all-species-were-caught-on-camera-most-often-around-dawn-6-am-and-dusk-6-pm.}
\begin{itemize}
\tightlist
\item
  True
...
\phantomsection\label{feedback-for-question-5}
\textbf{Answer:} False\\
...
\phantomsection\label{question-6}
\begin{block}{There is a strong negative correlation between the time of
sighting and the speed of the animal.}
\phantomsection\label{there-is-a-strong-negative-correlation-between-the-time-of-sighting-and-the-speed-of-the-animal.}
\begin{itemize}
\tightlist
\item
  True
...
\phantomsection\label{feedback-for-question-6}
\textbf{Answer:} False\\
...
\phantomsection\label{pie-plots}
That's the pie plot.
...
\phantomsection\label{espn-famous-athletes-by-sport}
...
\phantomsection\label{bar-plot-polar-coords-pie-plot}
...
\begin{frame}{Bar plot + polar coords = pie plot}
\phantomsection\label{bar-plot-polar-coords-pie-plot-1}
\begin{itemize}
\item
...
\begin{frame}{Bar plot + polar coords = pie plot}
\phantomsection\label{bar-plot-polar-coords-pie-plot-2}
...
\phantomsection\label{when-should-you-use-polar-coordinates}
\begin{itemize}
\item
...
\phantomsection\label{histogram-of-animal-activity}
...
\begin{frame}{Histogram of animal activity}
\phantomsection\label{histogram-of-animal-activity-1}
...
\phantomsection\label{histogram-polar-coords-rose-plot}
\begin{itemize}
\item
...
\begin{frame}{Histogram + polar coords = rose plot}
\phantomsection\label{histogram-polar-coords-rose-plot-1}
...
\phantomsection\label{practice-pie-plot-visualization}
...
\begin{frame}{Practice: Pie Plot Visualization}
\phantomsection\label{practice-pie-plot-visualization-1}
...
\begin{frame}{Practice: Pie Plot Visualization}
\phantomsection\label{practice-pie-plot-visualization-2}
\begin{itemize}
\item
...
\phantomsection\label{pie-plot-visualization}
...
\begin{frame}{Question}
\phantomsection\label{question-7}
\begin{block}{Which of the following statements is true?}
\phantomsection\label{which-of-the-following-statements-is-true}
\begin{enumerate}
\tightlist
\item
...
\phantomsection\label{feedback-for-question}
...
\begin{frame}{Nonsense bar lengths}
\phantomsection\label{nonsense-bar-lengths-2}
\begin{itemize}
\item
...
\phantomsection\label{the-same-applies-to-stacked-bar-plots}
It isn't just politicians who play fast and loose with the rules of data
visualization.
\end{frame}

\begin{frame}{The same applies to stacked bar plots}
\phantomsection\label{the-same-applies-to-stacked-bar-plots-1}
...
\begin{frame}{The same applies to stacked bar plots}
\phantomsection\label{the-same-applies-to-stacked-bar-plots-2}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{The same applies to stacked bar plots}
\phantomsection\label{the-same-applies-to-stacked-bar-plots-3}
\begin{itemize}
\item
...
\phantomsection\label{dual-axes-are-misleading}
Another common bad idea for plots is to use two y-axes.
\end{frame}

\begin{frame}{Dual axes are misleading}
\phantomsection\label{dual-axes-are-misleading-1}
...
\begin{frame}{Dual axes are misleading}
\phantomsection\label{dual-axes-are-misleading-2}
...
\begin{frame}{Dual axes are misleading}
\phantomsection\label{dual-axes-are-misleading-3}
\begin{itemize}
\item
...
\begin{frame}{Dual axes are misleading}
\phantomsection\label{dual-axes-are-misleading-4}
\begin{itemize}
\item
...
\phantomsection\label{better-to-use-multiple-panels}
...
\phantomsection\label{practice-bar-plot-visualization}
\begin{itemize}
\item
...
\begin{frame}{Practice Bar Plot Visualization}
\phantomsection\label{practice-bar-plot-visualization-1}
...
\begin{frame}{Practice Bar Plot Visualization}
\phantomsection\label{practice-bar-plot-visualization-2}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Question}
\phantomsection\label{question-8}
\begin{block}{Which of the following statements is true?}
\phantomsection\label{which-of-the-following-statements-is-true-1}
\begin{enumerate}
\tightlist
\item
...
\begin{frame}{Feedback for Question}
\phantomsection\label{feedback-for-question-7}
\textbf{Answer:}\\
...
\begin{frame}{Key Takeaway}
\phantomsection\label{key-takeaway-1}
...
\begin{frame}{Measures of a good visualization}
\phantomsection\label{measures-of-a-good-visualization-1}
\begin{itemize}
\item
...
\phantomsection\label{chartjunk}
\begin{itemize}
\item
...
\begin{frame}{Chartjunk}
\phantomsection\label{chartjunk-1}
\begin{itemize}
\item
...
\begin{frame}{Pictures}
\phantomsection\label{pictures-1}
...
\phantomsection\label{skeuomorphism}
...
\begin{frame}{Skeuomorphism}
\phantomsection\label{skeuomorphism-1}
\begin{itemize}
\item
...
\begin{frame}{Skeuomorphism}
\phantomsection\label{skeuomorphism-2}
...
\begin{frame}{Skeuomorphism}
\phantomsection\label{skeuomorphism-3}
...
\phantomsection\label{extra-dimensions}
...
\begin{frame}{Extra dimensions}
\phantomsection\label{extra-dimensions-1}
...
\begin{frame}{Extra dimensions}
\phantomsection\label{extra-dimensions-2}
\begin{itemize}
\item
...
\phantomsection\label{ostentatious-colors-and-lines}
...
\begin{frame}{Ostentatious colors and lines}
\phantomsection\label{ostentatious-colors-and-lines-1}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Ostentatious colors and lines}
\phantomsection\label{ostentatious-colors-and-lines-2}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Ostentatious colors and lines}
\phantomsection\label{ostentatious-colors-and-lines-3}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{practice-chartjunk}
...
\begin{frame}{Practice: Chartjunk}
\phantomsection\label{practice-chartjunk-1}
...
\begin{frame}{Question}
\phantomsection\label{question-9}
...
\begin{frame}{Key Takeaway}
\phantomsection\label{key-takeaway-2}
